...
X = df[final_features]
y = df['Reversal_rate']
#Best alpha for Org_selected_features is 2.5
#Best alpha for features3 is 4.83
...
print('mean square error (MSE) :',metrics.mean_squared_error(y_test,y_predicted))
print('root mean square error (RMSE) :',metrics.mean_squared_error(y_test,y_predicted,squared=False))
